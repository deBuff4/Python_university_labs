# Задание 2. 
# Для созданных массивов выполните вычисление суммы, среднего значения, минимального и максимального элементов, 
# а также стандартного отклонения с использованием встроенных функций NumPy.
# Продемонстрируйте поэлементные арифметические операции между массивами, а также между массивом и скаляром.
# Дополнительно реализуйте аналогичные операции с использованием стандартных средств Python без применения библиотеки NumPy.
# Сравните полученные результаты и сделайте вывод о различиях в удобстве и выразительности кода.

# Задание 3.
# Исследуйте влияние формы массива на выполнение вычислений. 
# Выполните агрегатные операции по строкам и столбцам двумерного массива с использованием параметра axis.
# Реализуйте аналогичные вычисления без использования NumPy, применяя циклы и стандартные структуры данных Python, и сравните подходы.

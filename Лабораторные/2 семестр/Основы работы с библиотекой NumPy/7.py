# Задание 7.
# Измените тип данных массива NumPy и проанализируйте влияние типа данных на результаты вычислений и объём используемой памяти.
# Сгенерируйте массив большого размера и сравните время выполнения операции суммирования с использованием NumPy и стандартных средств Python.
# Сделайте вывод о различиях в производительности.
